...
export const CoursePage = () => {
  ...
  const filteredCourses = courses.filter((course) => {
    ...
    return course.category?._id === selectedCategoryFilter;
  });
                      ...
                      {filteredCourses.length === 0 ? (
                        ...
                        filteredCourses.map((course) => (
                          <SpotlightCard
                            ...
                            style={{
                              flex: "1 1 calc(33.33% - 16px)", // Tercer parte del espacio (si quieres 3 cursos por fila)
                              minWidth: "300px", // Establece un tamaño mínimo para cada tarjeta
                            }}
                          >
                            <h3>{course.title}</h3>
                            <p>
