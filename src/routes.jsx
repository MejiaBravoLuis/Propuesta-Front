...
const routes = [
  ...
  { path: '/cursos', element: <PrivateRoute allowedRoles={["ADMIN", "TUTOR","STUDENT"]}><CoursePage /></PrivateRoute> },
  ...
  { path: '/category', element: <PrivateRoute allowedRoles={["ADMIN","STUDENT"]}><CategoryPage /></PrivateRoute> },
